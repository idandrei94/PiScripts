#!/bin/bash
apt-get update
apt-get install -y vim build-essential cmake python-dev python3-dev openjdk-8-jdk eclipse eclipse-cdt apache mysql-server libmysqlcppconn-dev chromium-browser codeblocks
